...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Modules" Type="Folder">
			...
			<Item Name="Main controller.lvlib" Type="Library" URL="../Modules/System Control/Main controller.lvlib"/>
			<Item Name="Events.lvlib" Type="Library" URL="../Modules/Events/Events.lvlib"/>
			<Item Name="Example Module.lvlib" Type="Library" URL="../Modules/Example Module/Example Module.lvlib"/>
			<Item Name="Shutter.lvlib" Type="Library" URL="../Modules/Shutter Module/Shutter.lvlib"/>
			<Item Name="Monochromator.lvlib" Type="Library" URL="../Modules/Monochromator/Monochromator.lvlib"/>
			<Item Name="Colour Wheel.lvlib" Type="Library" URL="../Modules/Colour Wheel/Colour Wheel.lvlib"/>
			<Item Name="DAQ.lvlib" Type="Library" URL="../Modules/DAQ/DAQ.lvlib"/>
			<Item Name="Scope.lvlib" Type="Library" URL="../Modules/Scope/Scope.lvlib"/>
			<Item Name="Serial comms.lvlib" Type="Library" URL="../Modules/Serial comms/Serial comms.lvlib"/>
			<Item Name="UI.lvlib" Type="Library" URL="../Modules/UI/UI.lvlib"/>
			<Item Name="File IO.lvlib" Type="Library" URL="../Modules/File IO/File IO.lvlib"/>
			<Item Name="Processing.lvlib" Type="Library" URL="../Modules/Processing/Processing.lvlib"/>
		</Item>
